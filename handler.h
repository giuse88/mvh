...
extern void  trusted_open    ( int, const struct syscall_header *);
...
extern void  trusted_getpid     ( int, const struct syscall_header *);
...
extern u64_t untrusted_clone(const ucontext_t * uc ); 
extern void  trusted_clone ( int fd, const struct syscall_header * header); 
